...
#5(+4)+6(+5)+7(+6)+8(+2)+9
	def generator_model(self):
		...
		if self.type_no==3:
			...
			layer_9 = Add()([PReLU(shared_axes=[1,2])(layer_9),layer_8])
			...
			#256
			layer_6 = Conv2D(self.filter_array[5], kernel_size=(5,5), padding="SAME")(layer_5)
			layer_6 = BatchNormalization()(layer_6)
				
			#layer_6 = Add()([PReLU(shared_axes=[1,2])(layer_6),layer_5])		
			#layer_6 = Add()([PReLU(shared_axes=[1,2])(layer_6),layer_2])		
			layer_6 = PReLU(shared_axes=[1,2])(layer_6)

			
			if self.inflow_layer!=None:
				layer_6 = Add()([layer_6, self.inflow_layer]) 	
